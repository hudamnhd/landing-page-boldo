    ...
    <section>
      <div className="px-3 py-7 md:py-14">
        <div className="space-y-3 text-center">
          ...
          <h1 className="mx-auto text-3xl leading-[42px] sm:text-[38px] sm:leading-[52px] md:text-[48px] md:leading-[72px] md:w-2/3">
            Handshake infographic mass market crowdfunding iteration.
          </h1>
        </div>
        <div
          id="services"
          className="md:container mx-auto mt-5 flex flex-wrap items-center justify-center rounded-xl px-5 sm:mt-10"
        >
          {services.map((service) => (
            ...
            >
              <img src={service.img} alt="" className="h-auto" />
